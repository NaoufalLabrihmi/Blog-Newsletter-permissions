<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-puzzle"></i>
                    {{ __('words.subscribers') }}</a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('dashboard/subscribers/sendemailall') }}">
                            <i class="icon-user-follow"></i>{{ __('words.sendemailToAll') }}
                        </a>
                        <a class="nav-link" href="{{ route('dashboard.subscribers.index') }}"><i class="icon-people"></i>
                            {{ __('words.subsc') }}</a>
                    </li>
                </ul>
            </li>
