...
<body class="navbar-fixed sidebar-nav fixed-nav">
            ...
            <ul class="nav navbar-nav pull-left hidden-md-down">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{ route('dashboard.users.edit', auth()->user()) }}"><i class="fa fa-user"></i> {{ __('words.user settings') }}</a>
    ...
    <footer class="footer">
        <a href="http://coreui.io" target="_blank"> <span class="text-left"> Naoufal
                &copy;
            </span></a>
